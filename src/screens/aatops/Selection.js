      ...
      return(
        <View style={styles.background_view}>
          ...
          <View style={{flex:8, alignItems:'flex-start',flexDirection:'row'} }>
              <View style={{flex:1}}>
                  <Button type='solid' title="Recoder" buttonStyle={styles.button} onPress={()=>this.props.navigation.navigate("Recodermood")}/>
              </View>
              <View style={{flex:1}}>
                  <Button type='solid' title="Master" buttonStyle={styles.button} onPress={()=>this.props.navigation.navigate("Mastermood")}/>
              </View>
